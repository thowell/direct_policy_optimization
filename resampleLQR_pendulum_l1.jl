...
z_sample_l2, u_sample_l2, J_sample_l2 = simulate_linear_controller(K_sample_l2,x_nom,u_nom,model_sim,Q,R,T_sim,Δt,z0_sim,w)
...
z_sample_l1, u_sample_l1, J_sample_l1 = simulate_linear_controller(K_sample_l1,x_nom,u_nom,model_sim,Q,R,T_sim,Δt,z0_sim,w)
...
plot!(t_nom[1:end-1],vcat(K_sample...)[:,1],legend=:bottom,label="sample (l2)",color=:orange,width=2.0,linetype=:steppost)
...
plot!(hcat(u_sample_l2...)',color=:orange,label="sample (l2)",linetype=:steppost)
plot!(hcat(u_sample_l1...)',color=:cyan,label="sample (l1)",linetype=:steppost)
