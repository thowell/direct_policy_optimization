...
# TVLQR policy
# TVLQR cost
Q_lqr = [t < T ? Diagonal(10.0*ones(model.nx)) : Diagonal(100*ones(model.nx)) for t = 1:T]
...
# Solve
Z_sample_sol = solve(prob_sample_moi,Z0_sample,max_iter=50)
