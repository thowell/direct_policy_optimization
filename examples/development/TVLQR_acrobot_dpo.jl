...
# TVLQR solution
Q = [t < T ? Diagonal([10.0;10.0;1.0;1.0]) : Diagonal([100.0;100.0;100.0;100.0]) for t = 1:T]
...
function con!(c,z)
    ...
    for t = 1:T-1
        ...
        xs⁺ = sample_dynamics_linear(xs,u,A_dyn[t],B_dyn[t],β=β,w=w,fast_sqrt=true)
...
z_sol_linear = solve(z0,prob_linear,max_iter=500)
