...
x1 = [-(0.5*model.r + 0.5 -0.5*model.r+0.75)/5, 0.5, 0.5*model.r + 0.5, 0.0, 0.0, 0., 0.5*model.r]
xT = x1#[0.0, 0.75, 0.5*model.r + 1.0, 0.0, 0.0, 0., 0.5*model.r]
